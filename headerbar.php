                        ...
                        <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
                            <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                                <a href="index.php" class="main-logo flex shrink-0 items-center">
                                    <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="PESTAKORA.png" alt="image" />
                                    <span
                            ...
                            <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                                    <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="https://upload.wikimedia.org/wikipedia/id/7/70/BPSDMhub.logo.png" alt="image" />
                            </div>
                            <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                                    <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="PPI.png" alt="image" />
                                    
                            </div>
                            <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                                    <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="demustar.png" alt="image" />
</div>
                                    ...
                                    >
                                        ...
                                        <li>
                                            <div class="flex items-center px-4 py-4">
                                                <div class="flex-none">
                                                    <img class="h-10 w-10 rounded-md object-cover" src="taruna.png" alt="image" />
                                                </div>
                                                <div class="truncate ltr:pl-4 rtl:pr-4">
                                                    <h4 class="text-base">
                                                        <?php echo $datanya['nama']; ?>
                                                        <span class="rounded bg-success-light px-1 text-xs text-success ltr:ml-2 rtl:ml-2"><?php echo $datanya['nit']; ?></span>
                                                    </h4>
                                                    <span class="rounded bg-success-light px-1 text-xs text-success ltr:ml-2 rtl:ml-2"><?php echo $datanya['nit']; ?></span>
...
<?php if($datanya['level'] == "admin") {
    ...
    <path d="M19.4 15a10 10 0 1 1-2.3-2.3" />
</svg>

                                        <span class="px-1">Admin menu</span>
                                    </div>
