                            ...
                            <div class="mb-4 grid gap-4 xl:grid-cols-3">
                                <div class="panel h-full xl:col-span-2">
                                    <div class="mb-5 flex items-center dark:text-white-light">
                                        <h5 class="text-lg font-semibold">Kontak</h5>
                                        
                                    </div>
                                    <p class="text-lg dark:text-white-light/90">Apabila ada pertanyaan dapat disampaikan melalui danton per kelas maupun kepada panitia </p>
