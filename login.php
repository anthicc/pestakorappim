...
<?php 
    ...
    <button type="submit" name="submit" class="btn btn-primary">Login</button>
                                ...
                                <div class="panel">
                                    ...
                                    <div class="border-b border-white-light p-6 text-[22px] font-bold dark:border-dark dark:text-white">FAQ</div>
                                    ...
                                    <div>
                                        <div class="flex cursor-pointer items-center justify-between gap-10 px-2.5 py-2 text-base font-semibold hover:bg-primary-light hover:text-primary dark:text-white dark:hover:bg-[#1B2E4B] dark:hover:text-primary bg-primary-light dark:bg-[#1B2E4B] !text-primary" :class="{'bg-primary-light dark:bg-[#1B2E4B] !text-primary' : active === 1}" x-on:click="active === 1 ? active = null : active = 1">
                                            <span>Apa itu PESTAKORA?</span>
                                        ...
                                        <div x-show="active === 1" x-collapse="">
                                            <div class="px-1 py-3 font-semibold text-white-dark">
                                                <p>
                                                    PESTAKORA merupakan kepanjangan dari Pesta Demokrasi Taruna yang merupakan Pemilihan Komandan Batalyon dan Ketua Demustar periode 2023/2024
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="flex cursor-pointer items-center justify-between gap-10 px-2.5 py-2 text-base font-semibold hover:bg-primary-light hover:text-primary dark:text-white dark:hover:bg-[#1B2E4B] dark:hover:text-primary" :class="{'bg-primary-light dark:bg-[#1B2E4B] !text-primary' : active === 2}" x-on:click="active === 2 ? active = null : active = 2">
                                            <span> Bagaimana cara memilih Calon?</span>
                                        ...
                                        <div x-show="active === 2" x-collapse="" style="display: none; height: 0px; overflow: hidden;" hidden="">
                                            <div class="px-1 py-3 font-semibold text-white-dark">
                                                <p>
                                                    Para Taruna dapat memilih kandidat komandan batalyon dan ketua demustar menggunakan akun yang telah disediakan oleh panitia.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="flex cursor-pointer items-center justify-between gap-10 px-2.5 py-2 text-base font-semibold hover:bg-primary-light hover:text-primary dark:text-white dark:hover:bg-[#1B2E4B] dark:hover:text-primary" :class="{'bg-primary-light dark:bg-[#1B2E4B] !text-primary' : active === 3}" x-on:click="active === 3 ? active = null : active = 3">
                                            <span>Bagaimana jika terdapat kendala terkait pemilihan?</span>
                                        ...
                                        <div x-show="active === 3" x-collapse="" style="display: none; height: 0px; overflow: hidden;" hidden="">
                                            <div class="px-1 py-3 font-semibold text-white-dark">
                                                <p>
                                                Para Taruna dapat menghubungi panitia melalui masing-masing danton apabila terdapat permasalahan terkait pemilihan.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div x-show="active === 5" x-collapse="" style="display: none; height: 0px; overflow: hidden;" hidden="">
                                            <div class="px-1 py-3 font-semibold text-white-dark">
                                                <p>
